...
class OrderDetail(models.Model):
    o_num = models.IntegerField(verbose_name='订单号', primary_key=True)
    ...
    # def go_to(self):
    #     return mark_safe("<a href='http://127.0.0.1:8888/admin/orders/orderdetail/'>发货</a>")
    # go_to.short_description = '发货'
    #
    # def go(self):
    #     return "{}的商品{}".format(self.o_user.user_name, self.o_goods.goods_name)
