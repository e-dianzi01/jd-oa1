    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('good_img', models.CharField(blank=True, max_length=255, null=True, verbose_name='商品展示图片')),
                ...
                ('lable', models.CharField(blank=True, max_length=100, null=True, verbose_name='标签')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('one_type_name', models.CharField(max_length=20, verbose_name='一级分类名称')),
                ('remark', models.CharField(blank=True, max_length=50, null=True, verbose_name='备注')),
                ('type_img', models.CharField(max_length=255, verbose_name='一级分类图片')),
            ],
            options={
                'verbose_name': '商品分类表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('two_type_name', models.CharField(max_length=20, verbose_name='二级分类名称')),
                ('remark', models.CharField(blank=True, max_length=50, null=True, verbose_name='备注')),
                ('type_img', models.CharField(max_length=255, verbose_name='二级分类图片')),
            ],
            options={
                'verbose_name': '商品分类表',
                'verbose_name_plural': '商品分类表',
